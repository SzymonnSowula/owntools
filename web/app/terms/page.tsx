...
export const metadata: Metadata = {
  title: "Terms",
  description:
    "The plain-English rules for using shipshape and the Pro key: a personal, non-transferable license, no resale of keys, software provided as is, Polish law.",
...
export default function TermsPage() {
  return (
    <LegalPage
      kicker="legal"
      title="terms"
      intro="The plain-English rules for using shipshape and the Pro key. They are short because the product is simple: a desktop app that runs on your machine, and a key that removes a badge."
      updated={POLICIES_UPDATED}
    >
      <h2>the free app</h2>
      <p>
        shipshape is free to download and use, for personal and commercial work alike. Every tool
        is included. The only difference from Pro is a small “made with shipshape” badge on the
        videos you export.
      </p>
      ...
      <p>
        ...
        shipshape without the badge. The key:
      </p>
      <ul>
      ...
      <h2>your files</h2>
      <p>
        Everything you make with shipshape is yours. We claim no rights to your recordings, notes,
      ...
      <h2>as is</h2>
      <p>
        shipshape is provided as is, without warranty of any kind. We work hard to make it
      ...
      <h2>governing law</h2>
      <p>
        shipshape is operated from Poland. These terms are governed by Polish law, and disputes
