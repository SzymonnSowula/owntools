...
const ITEMS: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: "Yes. No accounts, no telemetry, no cloud rendering. Recordings, notes, boards, captures, meetings, scheduled posts and the keys to your social accounts live in files on your disk. Speech recognition and the language model run on your CPU - audio never leaves the machine. The only outbound traffic is what you asked for - a model download, an update check, the post you scheduled - and Settings → Privacy lists each one.",
  },
  {
